...
test_that('add_management enforces the use of green manure when growing maize or potato on sand', {
  maize_potato_codes <- crops.obic[crop_name_scientific %in% c('solanum tuberosum', 'zea mays'), crop_code]
    # should include c(259, 316, 317, 814, 859, 1909, 1910, 1911, 1912, 1928, 1929, 1935, 2014:2017, 2025, 2032, 2951, 3730:3732, 3792)
